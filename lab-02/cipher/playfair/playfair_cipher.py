# Phần định nghĩa lớp PlayFairCipher
# (Giả sử nằm trong file playfair_cipher.py hoặc tương tự)
...
class PlayFairCipher:
    ...
    def create_playfair_matrix(self, key):
        ...
        matrix = list(key)
        # Thêm các ký tự duy nhất từ khóa (theo thứ tự xuất hiện)
    ...
    def playfair_encrypt(self, plain_text, matrix):
        ...
        # Loại bỏ các ký tự không phải chữ cái và chuẩn bị cặp ký tự
        encrypted_text = ""
    ...
    def playfair_decrypt(self, cipher_text, matrix):
        ...
        for i in range(0, len(cipher_text), 2):
            ...
            if len(pair) < 2 : continue # Bỏ qua nếu cặp không đủ (dù ciphertext playfair luôn chẵn)
